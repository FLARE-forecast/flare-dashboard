...
```{r feea-mixing}
s3_feea <- arrow::s3_bucket(bucket = "bio230121-bucket01/flare/forecasts/parquet/site_id=feea/model_id=glm_flare_v3", endpoint_override = "renc.osn.xsede.org", anonymous = TRUE)
