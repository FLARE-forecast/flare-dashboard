...
The National Ecological Observatory Network (NEON) is a U.S. National Science Foundation funded project to monitor 81 ecosystems across the U.S. using standardized measurements over the next 30 years.  We generate forecast for the seven lakes that are monitored by NEON.  These lakes range from hot humid (Florida) to cold tundra (Alaska).
