...
```{r alex-mixing}
s3_alex <- arrow::s3_bucket(bucket = "bio230121-bucket01/flare/forecasts/parquet/site_id=ALEX/model_id=glm_flare_v3", endpoint_override = "amnh1.osn.mghpcc.org", anonymous = TRUE)
