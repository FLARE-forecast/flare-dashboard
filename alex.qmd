...
```{r cann-mixing}
s3_cann <- arrow::s3_bucket(bucket = "bio230121-bucket01/flare/forecasts/parquet/site_id=CANN/model_id=glm_flare_v3", endpoint_override = "renc.osn.xsede.org", anonymous = TRUE)
