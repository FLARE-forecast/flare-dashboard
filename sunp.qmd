...
s3_sunp <- arrow::s3_bucket(bucket = "bio230121-bucket01/flare/forecasts/parquet/site_id=sunp/model_id=glm_flare_v1", endpoint_override = "renc.osn.xsede.org", anonymous = TRUE)
