...
```{r ccre-mixing}
s3_ccre <- arrow::s3_bucket(bucket = "bio230121-bucket01/flare/forecasts/parquet/site_id=ccre/model_id=glm_flare_v3", endpoint_override = "amnh1.osn.mghpcc.org", anonymous = TRUE)
...
plot_mixing(forecast_df = temperature_forecast, eval_depths = c(1, 18), use_density = T, threshold = 0.1)
