...
```{r fcre-mixing}
s3_fcre <- arrow::s3_bucket(bucket = "bio230121-bucket01/flare/forecasts/parquet/site_id=fcre/model_id=glm_flare_v1", endpoint_override = "renc.osn.xsede.org", anonymous = TRUE)
...
```{r bvre-mixing}
# chance of being mixed
s3_bvre <- arrow::s3_bucket(bucket = "bio230121-bucket01/flare/forecasts/parquet/site_id=bvre/model_id=glm_flare_v1", endpoint_override = "renc.osn.xsede.org", anonymous = TRUE)

temperature_forecast <- arrow::open_dataset(s3_fcre) |> 
  filter(variable == "temperature",
         #site_id %in% c("bvre"),
         reference_datetime == most_recent) |> 
  dplyr::collect() 
...
```{r ccre-mixing}
s3_ccre <- arrow::s3_bucket(bucket = "bio230121-bucket01/flare/forecasts/parquet/site_id=ccre/model_id=glm_flare_v1", endpoint_override = "renc.osn.xsede.org", anonymous = TRUE)
